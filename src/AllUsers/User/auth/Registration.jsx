...
import useSignUp from "../../customHooks/auth/useSignup";
import useGetCountries from "../../customHooks/auth/useGetCountries";
...
function Register(props) {
    ...
    const handleSignUp = (e) => {
        e.preventDefault();
        signUp(email, firstName, lastName, dob, country, phoneNumber, address, password, navigate);
    };
