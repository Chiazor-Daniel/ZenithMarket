...
const ThemeContextProvider = (props) => {
  ...
  const changeSideBarLayout = (name) => {
    if (name.value === "horizontal" && sideBarStyle.value === "overlay") {
      dispatch({ sidebarLayout: name, sideBarStyle: { value: "full", label: "Full" } });
  ...
  const changeSideBarStyle = (name) => {
    if (sidebarLayout.value === "horizontal" && name.value === "overlay") {
      ...
      dispatch({ sideBarStyle: name, iconHover: name.value === "icon-hover" ? "_i-hover" : "" });
  ...
  const setDemoTheme = (theme, direction) => {
    ...
    changeSideBarPostion({ value: themeSettings.sidebarPosition });
    changeHeaderPostion({ value: themeSettings.headerPosition });
    changeContainerPosition({ value: themeSettings.containerLayout });
    changeDirectionLayout({ value: direction });
  };
  ...
  useEffect(() => {
    ...
    const resizeWindow = () => {
      dispatch({ windowWidth: window.innerWidth, windowHeight: window.innerHeight });
